 ...
 * @author audre
 */
public class MathComputer extends javax.swing.JFrame {
    ImageIcon icon = new ImageIcon("src\\images\\Lock.PNG");

    /**
     * Creates new form MathComputer
     */
    public MathComputer() {
        initComponents();
        jLabel4.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MathComputer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MathComputer().setVisible(true);
            }
        });
    }
