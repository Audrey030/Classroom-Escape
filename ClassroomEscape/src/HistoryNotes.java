...
//Hints to the history exit ticket

/**
 *
 * @author audre
 */
public class HistoryNotes extends javax.swing.JFrame {
    ImageIcon icon = new ImageIcon("src\\images\\notes.PNG");
    
    /**
     * Creates new form HistoryNotes
     */
    public HistoryNotes() {
        initComponents();
        jLabel3.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistoryNotes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HistoryNotes().setVisible(true);
            }
        });
    }
