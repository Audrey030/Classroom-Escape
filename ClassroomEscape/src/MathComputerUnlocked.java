...
//After the password is entered, the computer will show a hint for the door lock

/**
 *
 * @author audre
 */
public class MathComputerUnlocked extends javax.swing.JFrame {
    ImageIcon icon = new ImageIcon("src\\images\\Triangles.PNG");
    /**
     * Creates new form MathComputerUnlocked
     */
    public MathComputerUnlocked() {
        initComponents();
        jLabel2.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MathComputerUnlocked.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MathComputerUnlocked().setVisible(true);
            }
        });
    }
